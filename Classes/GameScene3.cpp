...
bool GameScene3::init()
{
	...
	//创建炸弹按钮
	auto btn1 = MenuItemImage::create("boom.png", "boom.png", CC_CALLBACK_1(GameScene3::setBomb, this));
	auto btn2 = MenuItemImage::create("boom2.png", "boom2.png", CC_CALLBACK_1(GameScene3::setBomb2, this));
...
void GameScene3::setBomb(Ref* ref) {
	...
	schedule(schedule_selector(GameScene3::BombsMove3), 0.01f);
	schedule(schedule_selector(GameScene::eraseBomb), 1.0f);
}

void GameScene3::setBomb2(Ref* ref)
{
...
void GameScene3::BombsMove3(float f) {
